...
#ifndef RIEGELI_BYTES_HADOOP_SNAPPY_WRITER_H_
#define RIEGELI_BYTES_HADOOP_SNAPPY_WRITER_H_
...
class HadoopSnappyWriterBase : public PushableWriter {
 public:
  ...
  // `HadoopSnappyWriterBase` overrides `Writer::Fail()` to annotate the status
 ...
 protected:
  ...
  explicit HadoopSnappyWriterBase(Position size_hint);
...
inline HadoopSnappyWriterBase::HadoopSnappyWriterBase(Position size_hint)
...
inline void HadoopSnappyWriterBase::Reset(Position size_hint) {
...
template <typename Dest>
struct Resetter<HadoopSnappyWriter<Dest>>
    : ResetterByReset<HadoopSnappyWriter<Dest>> {};

}  // namespace riegeli

#endif  // RIEGELI_BYTES_HADOOP_SNAPPY_WRITER_H_
