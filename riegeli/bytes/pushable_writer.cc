...
void PushableWriter::WriteHintBehindScratch(size_t length) {
  RIEGELI_ASSERT_LT(available(), length)
      << "Failed precondition of PushableWriter::WriteHintBehindScratch(): "
...
void PushableWriter::WriteHintSlow(size_t length) {
  RIEGELI_ASSERT_LT(available(), length)
