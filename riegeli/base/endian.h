...
// byte array using memcpy() writes the number in 16-bit Little Endian encoding.
...
// byte array using memcpy() writes the number in 32-bit Little Endian encoding.
...
// byte array using memcpy() writes the number in 64-bit Little Endian encoding.
...
// word read from the byte array using memcpy(), converts the word to the native
// 16-bit number.
